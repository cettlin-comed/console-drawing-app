...
class RectangleInputValidatonTest {
    ...
    fun testValidRectangleInput() {
        ...
        val args = testInputValidator.parseAndValidateRectangleInput(inputArgs)
    ...
    fun testInvalidRectangleInput() {
        ...
        assertFailsWith<InputValueException> {
            testInputValidator.parseAndValidateRectangleInput(inputArgs)
        }
    }
